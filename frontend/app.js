  ...
  for (const contractInterface of interfaces) {
    try {
      ...
      const messages = {
        ...
        ERC20InsufficientAllowance: "Approve ALANI first, then place the bid.",
        ERC20InsufficientBalance: "This wallet does not have enough ALANI.",
        OwnableUnauthorizedAccount: "Only the token owner can perform this action.",
